...
class LogUser:
    ...
    def setup_ui(self):
        ...
        button_admin.pack(side=tk.LEFT, padx=(18, 5))
        button_login.pack(side=tk.LEFT, padx=(5, 0))
...
class UserDashboard(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.numPane = tk.Label(room_frame, text="", font=("Segoe UI Black", 48), fg="#136291", bg="#CBDBEB")
    ...
    def create_user_info_widgets(self):
        ...
        self.userdashName = tk.Label(self.panel2, text="", font=("Segoe UI Black", 22,"bold"),fg="#136291", bg="#CBDBEB", width=22)
        ...
        self.userdashBill = tk.Label(self.panel2, text="", font=("Segoe UI Black", 22,"bold"), fg="#136291",bg="#CBDBEB", width=10)
        self.userdashBill.pack(anchor='w', padx=(10,0))

        tk.Label(self.panel2, text="DUEDATE:", font=("Segoe UI Black", 15), fg="#136291", bg="#CBDBEB").pack(pady=(10, 0), padx = (0, 240))
        self.userdashDate = tk.Label(self.panel2, text="", font=("Segoe UI Black", 22,"bold"), fg="#136291",bg="#CBDBEB", width=10)
        self.userdashDate.pack(anchor='w', padx=(53,0))
